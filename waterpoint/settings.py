# Django settings for waterpoint project.
import os
...
SECRET_KEY = ')&xh5e#ve1#o%ob*d5+n0767p23!5+y15t(!t)ey0$-_rbc=z3'
...
ROOT_URLCONF = 'waterpoint.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'waterpoint.wsgi.application'
